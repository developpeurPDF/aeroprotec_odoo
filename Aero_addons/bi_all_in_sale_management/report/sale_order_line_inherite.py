...
class sale_order_line_inherite(models.Model):
    ...
    def _compute_per(self):
        for line in self:
            ...
            if line.tax_id and line.price_unit and line.product_uom_qty:
    ...
    def _compute_cost_product(self):
        for line in self:
            ...
            line.update({
                'product_cost' : (line.product_id.with_company(company).standard_price * line.product_uom_qty) or 0.00
                })
