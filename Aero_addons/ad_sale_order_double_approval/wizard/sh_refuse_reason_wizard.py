...
class RefuseReasonWizard(models.TransientModel):
    ...
    sh_refuse_reason_id = fields.Many2one("sh.so.refuse.reason",string="Raison de refus",required=True,help="This field display a list of reasons for refusing sale order")
    sh_refuse_comment = fields.Text(string="Commentaire")
