...
class MrpRoutingWorkcenter(models.Model):
    ...
    norme_interne = fields.Many2one('norme', string="Norme Interne", domain=[('type_norme','=','interne')], tracking=True)
    norme_externe = fields.Many2one('norme', string="Norme Externe", domain=[('type_norme','=','externe')], tracking=True)
    # code = fields.Char(string="Code")
