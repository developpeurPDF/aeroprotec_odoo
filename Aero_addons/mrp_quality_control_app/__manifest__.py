# -*- coding: utf-8 -*-
{
    ...
    'summary': "Quality control for MRP quality control for manufacturing quality control inspection qc MRP QC validation MRP quality assurance manufacturing quality control manufacturing inspection warehouse quality control purchase inspections quality inspection alerts.",
    'description': """This app help to user for quality control like quality check and quality alert with pass-fail type, measure type, picture type and text type for manufacturing and warehouse operations. 
